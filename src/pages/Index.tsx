        ...
        <Tabs defaultValue="properties" className="space-y-6">
              ...
              <Card className="interactive-card animate-fade-in overflow-hidden">
                ...
                <CardContent className="space-y-4 overflow-hidden">
                  <div className="space-y-2 hover-scale p-2 rounded">
                    ...
                    <p className="break-words text-sm">레몬, 식초와 같은 신맛을 가집니다.</p>
                  </div>
                  <div className="space-y-2 hover-scale p-2 rounded">
                    <Badge variant="destructive">리트머스 시험지</Badge>
                    <p className="break-words text-sm">파란색 리트머스 시험지를 빨간색으로 변화시킵니다.</p>
                  </div>
                  <div className="space-y-2 hover-scale p-2 rounded">
                    <Badge variant="destructive">금속과 반응</Badge>
                    <p className="break-words text-sm">아연, 철 등과 반응하여 수소 기체를 발생시킵니다.</p>
                  </div>
                  <div className="space-y-2 hover-scale p-2 rounded">
                    <Badge variant="destructive">부식성</Badge>
                    <p className="break-words text-sm">농도가 진할 때 금속이나 피부를 부식시킵니다.</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="interactive-card animate-fade-in overflow-hidden" style={{animationDelay: '0.2s'}}>
                ...
                <CardContent className="space-y-4 overflow-hidden">
                  <div className="space-y-2 hover-scale p-2 rounded">
                    ...
                    <p className="break-words text-sm">쓴맛을 가지며, 미끄러운 느낌이 납니다.</p>
                  </div>
                  <div className="space-y-2 hover-scale p-2 rounded">
                    <Badge variant="secondary">리트머스 시험지</Badge>
                    <p className="break-words text-sm">빨간색 리트머스 시험지를 파란색으로 변화시킵니다.</p>
                  </div>
                  <div className="space-y-2 hover-scale p-2 rounded">
                    <Badge variant="secondary">단백질 분해</Badge>
                    <p className="break-words text-sm">단백질을 분해하는 성질이 있습니다.</p>
                  </div>
                  <div className="space-y-2 hover-scale p-2 rounded">
                    <Badge variant="secondary">부식성</Badge>
                    <p className="break-words text-sm">강염기는 피부나 옷을 손상시킬 수 있습니다.</p>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <Card className="animate-fade-in overflow-hidden">
              ...
              <CardContent className="space-y-6 overflow-hidden">
                <div className="grid md:grid-cols-3 gap-4">
                  <Card className="border-gray-300 interactive-card overflow-hidden">
                  ...
                  <Card className="border-red-300 interactive-card overflow-hidden">
                    <CardHeader className="text-center">
                  ...
                  <Card className="border-blue-300 interactive-card overflow-hidden">
                    <CardHeader className="text-center">
                ...
                <div className="p-4 bg-muted rounded-lg overflow-hidden">
                  ...
                  <div className="space-y-2">
                    <p className="text-sm break-words"><strong>1. 이온화:</strong> 산과 염기가 물에 녹으면서 이온으로 분리됩니다.</p>
                    <p className="text-sm break-words"><strong>2. 전하 이동:</strong> 이온들이 전기를 운반하는 역할을 합니다.</p>
                    <p className="text-sm break-words"><strong>3. 농도 관계:</strong> 농도가 진할수록 이온이 많아져 전기전도도가 높아집니다.</p>
                    <p className="text-sm break-words"><strong>4. 온도 영향:</strong> 온도가 높을수록 이온의 움직임이 활발해집니다.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="indicators">
            <Card className="animate-fade-in overflow-hidden">
              ...
              <CardContent className="space-y-6 overflow-hidden">
                {selectedIndicator && (
                  <div className="p-4 bg-gradient-to-r from-red-50 via-purple-50 to-blue-50 rounded-lg border animate-scale-in overflow-hidden">
                    <h4 className="font-bold mb-4 text-center break-words">🧪 {selectedIndicator === 'litmus' ? '리트머스' : selectedIndicator === 'phenol' ? '페놀프탈레인' : '메틸오렌지'} 색 변화 실험</h4>
                    <div className="grid grid-cols-3 gap-4 text-center">
                      <div className="space-y-2">
                        <p className="font-bold text-sm">산성 용액</p>
                        <div className={`color-indicator mx-auto ${getIndicatorColor(selectedIndicator, 'acid')} animate-scale-in`}></div>
                      </div>
                      <div className="space-y-2">
                        <p className="font-bold text-sm">중성 용액</p>
                      ...
                      <div className="space-y-2">
                        <p className="font-bold text-sm">염기성 용액</p>
                ...
                <div className="grid gap-4 overflow-hidden">
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="text-center font-bold p-2 bg-muted rounded text-sm">지시약</div>
                    <div className="text-center font-bold p-2 bg-red-100 rounded text-red-700 text-sm">산성 용액</div>
                    <div className="text-center font-bold p-2 bg-blue-100 rounded text-blue-700 text-sm">염기성 용액</div>
                  </div>
                  
                  <div className="grid md:grid-cols-3 gap-4 items-center">
                    <div className="p-3 bg-background rounded border hover-scale overflow-hidden">
                      <strong className="text-sm">리트머스 시험지</strong>
                      <p className="text-xs text-muted-foreground break-words">가장 기본적인 지시약</p>
                    </div>
                    <div className="p-3 bg-red-50 rounded border border-red-200 text-center hover-scale">
                      <span className="text-red-600 font-bold animate-pulse text-sm">빨간색</span>
                    </div>
                    <div className="p-3 bg-blue-50 rounded border border-blue-200 text-center hover-scale">
                      <span className="text-blue-600 font-bold animate-pulse text-sm">파란색</span>
                    </div>
                  </div>

                  <div className="grid md:grid-cols-3 gap-4 items-center">
                    <div className="p-3 bg-background rounded border hover-scale overflow-hidden">
                      <strong className="text-sm">페놀프탈레인</strong>
                      <p className="text-xs text-muted-foreground break-words">염기성에서만 색 변화</p>
                    </div>
                    <div className="p-3 bg-gray-50 rounded border border-gray-200 text-center hover-scale">
                      <span className="text-gray-600 font-bold text-sm">무색</span>
                    </div>
                    <div className="p-3 bg-pink-50 rounded border border-pink-200 text-center hover-scale">
                      <span className="text-pink-600 font-bold animate-pulse text-sm">붉은색</span>
                    </div>
                  </div>

                  <div className="grid md:grid-cols-3 gap-4 items-center">
                    <div className="p-3 bg-background rounded border hover-scale overflow-hidden">
                      <strong className="text-sm">메틸오렌지</strong>
                      <p className="text-xs text-muted-foreground break-words">산성에서 색 변화</p>
                    </div>
                    <div className="p-3 bg-red-50 rounded border border-red-200 text-center hover-scale">
                      <span className="text-red-600 font-bold animate-pulse text-sm">빨간색</span>
                    </div>
                    <div className="p-3 bg-yellow-50 rounded border border-yellow-200 text-center hover-scale">
                      <span className="text-yellow-600 font-bold animate-pulse text-sm">노란색</span>
                    </div>
                  </div>

                  <div className="grid md:grid-cols-3 gap-4 items-center">
                    <div className="p-3 bg-background rounded border hover-scale overflow-hidden">
                      <strong className="text-sm">BTB</strong>
                      <p className="text-xs text-muted-foreground break-words">(브로모티몰블루)</p>
                    </div>
                    <div className="p-3 bg-yellow-50 rounded border border-yellow-200 text-center hover-scale">
                      <span className="text-yellow-600 font-bold animate-pulse text-sm">노란색</span>
                    </div>
            ...
            <Card className="animate-fade-in overflow-hidden">
              ...
              <CardContent className="space-y-6 overflow-hidden">
                {neutralizationStep > 0 && (
                  <div className="p-4 bg-gradient-to-r from-orange-50 to-yellow-50 rounded-lg border animate-scale-in overflow-hidden">
                    <h4 className="font-bold mb-3 text-center break-words">🌡️ 실시간 중화반응 관찰</h4>
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="text-center">
                        <p className="font-bold mb-2 text-sm">온도 변화</p>
                      ...
                      <div className="text-center">
                        <p className="font-bold mb-2 text-sm">반응 단계</p>
                        <div className="space-y-2">
                          <div className={`p-2 rounded text-sm ${neutralizationStep >= 1 ? 'bg-green-100 text-green-700' : 'bg-gray-100'} transition-all duration-500`}>
                            1단계: 산 투입
                          </div>
                          <div className={`p-2 rounded text-sm ${neutralizationStep >= 2 ? 'bg-green-100 text-green-700' : 'bg-gray-100'} transition-all duration-500`}>
                            2단계: 염기 투입
                          </div>
                          <div className={`p-2 rounded text-sm ${neutralizationStep >= 3 ? 'bg-green-100 text-green-700' : 'bg-gray-100'} transition-all duration-500`}>
                            3단계: 중화 완료
                          </div>
                        </div>
                      </div>
                ...
                <div className="p-6 bg-gradient-to-r from-red-50 to-blue-50 rounded-lg border animate-fade-in overflow-hidden">
                  <h3 className="text-xl font-bold mb-4 text-center break-words">중화반응 화학식</h3>
                  <div className="text-center text-lg font-mono break-words">
                  ...
                  <p className="text-center mt-2 text-muted-foreground text-sm break-words">산 + 염기 → 물 + 염</p>
                </div>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm">온도 상승 관찰</span>
                        </div>
                        <p className="text-sm break-words">중화반응은 <strong>발열반응</strong>으로 열이 발생합니다.</p>
                        <div className="p-3 bg-orange-50 rounded border border-orange-200">
                          <p className="text-sm break-words"><strong>이유:</strong> H⁺와 OH⁻가 결합하여 물을 만들 때 에너지가 방출됩니다.</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm">전체 부피 감소</span>
                        </div>
                        <p className="text-sm break-words">이론적으로는 부피가 <strong>약간 감소</strong>합니다.</p>
                        <div className="p-3 bg-blue-50 rounded border border-blue-200">
                          <p className="text-sm break-words"><strong>이유:</strong> 이온들이 물 분자를 형성하면서 부피가 줄어듭니다.</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="text-center p-4 border border-red-200 rounded bg-red-50 interactive-card animate-fade-in overflow-hidden">
                    <h4 className="font-bold text-red-700 text-sm">반응 전 (산성)</h4>
                    <div className="my-3">
                    ...
                    <Badge variant="destructive" className="text-xs">산성</Badge>
                  </div>

                  <div className="text-center p-4 border border-green-200 rounded bg-green-50 interactive-card animate-fade-in overflow-hidden" style={{animationDelay: '0.2s'}}>
                    <h4 className="font-bold text-green-700 text-sm">중화점</h4>
                    <div className="my-3">
                    ...
                    <Badge className="bg-green-500 text-xs">중성</Badge>
                  </div>

                  <div className="text-center p-4 border border-blue-200 rounded bg-blue-50 interactive-card animate-fade-in overflow-hidden" style={{animationDelay: '0.4s'}}>
                    <h4 className="font-bold text-blue-700 text-sm">반응 후 (염기성)</h4>
                    <div className="my-3">
                    ...
                    <Badge variant="secondary" className="text-xs">염기성</Badge>
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="interactive-card animate-fade-in overflow-hidden">
                ...
                <CardContent className="space-y-4">
                  <div className="p-3 border border-green-200 rounded bg-green-50 hover-scale overflow-hidden">
                    <h4 className="font-bold text-green-700 animate-pulse text-sm">제산제 복용</h4>
                    <p className="text-sm mt-1 break-words">위산(HCl) + 제산제(Mg(OH)₂) → 중화</p>
                    <p className="text-xs text-muted-foreground break-words">위산과다로 인한 속쓰림 완화</p>
                  </div>
                  
                  <div className="p-3 border border-blue-200 rounded bg-blue-50 hover-scale overflow-hidden">
                    <h4 className="font-bold text-blue-700 text-sm">베이킹소다 사용</h4>
                    <p className="text-sm mt-1 break-words">산성 냄새 제거, 청소에 활용</p>
                    <p className="text-xs text-muted-foreground break-words">NaHCO₃가 산을 중화</p>
                  </div>

                  <div className="p-3 border border-purple-200 rounded bg-purple-50 hover-scale overflow-hidden">
                    <h4 className="font-bold text-purple-700 text-sm">치약 사용</h4>
                    <p className="text-sm mt-1 break-words">구강 내 산성 환경 중화</p>
                    <p className="text-xs text-muted-foreground break-words">충치 예방에 도움</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="interactive-card animate-fade-in overflow-hidden" style={{animationDelay: '0.2s'}}>
                ...
                <CardContent className="space-y-4">
                  <div className="p-3 border border-orange-200 rounded bg-orange-50 hover-scale overflow-hidden">
                    <h4 className="font-bold text-orange-700 animate-pulse text-sm">산성비 중화</h4>
                    <p className="text-sm mt-1 break-words">석회석(CaCO₃)으로 토양 중화</p>
                    <p className="text-xs text-muted-foreground break-words">농업에서 토양 pH 조절</p>
                  </div>
                  
                  <div className="p-3 border border-cyan-200 rounded bg-cyan-50 hover-scale overflow-hidden">
                    <h4 className="font-bold text-cyan-700 text-sm">폐수 처리</h4>
                    <p className="text-sm mt-1 break-words">산업폐수의 pH 조절</p>
                    <p className="text-xs text-muted-foreground break-words">환경오염 방지</p>
                  </div>

                  <div className="p-3 border border-red-200 rounded bg-red-50 hover-scale overflow-hidden">
                    <h4 className="font-bold text-red-700 text-sm">화재 진압</h4>
                    <p className="text-sm mt-1 break-words">산 화재 시 염기성 물질 사용</p>
                    <p className="text-xs text-muted-foreground break-words">화학적 중화로 진압</p>
                  </div>
                </CardContent>
              </Card>

              <Card className="md:col-span-2 interactive-card animate-fade-in overflow-hidden" style={{animationDelay: '0.4s'}}>
                <CardHeader>
                  <CardTitle>🍯 음식에서의 중화반응</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="p-3 border rounded hover-scale overflow-hidden">
                      <h4 className="font-bold animate-bounce-gentle text-sm">빵 만들기</h4>
                      <p className="text-sm mt-1 break-words">베이킹소다 + 산성 재료</p>
                      <p className="text-xs text-muted-foreground break-words">CO₂ 발생으로 빵이 부풀어 오름</p>
                    </div>
                    
                    <div className="p-3 border rounded hover-scale overflow-hidden">
                      <h4 className="font-bold text-sm">김치 담그기</h4>
                      <p className="text-sm mt-1 break-words">소금으로 pH 조절</p>
                      <p className="text-xs text-muted-foreground break-words">적절한 발효 환경 조성</p>
                    </div>

                    <div className="p-3 border rounded hover-scale overflow-hidden">
                      <h4 className="font-bold text-sm">과일 보관</h4>
                      <p className="text-sm mt-1 break-words">레몬즙으로 산화 방지</p>
                      <p className="text-xs text-muted-foreground break-words">산성 환경에서 변색 방지</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                {!quizCompleted ? (
                  <div className="space-y-6">
                    ...
                    {quizQuestions.map((question, index) => (
                      <div key={index} className="p-4 border rounded-lg interactive-card animate-fade-in overflow-hidden" style={{animationDelay: `${index * 0.1}s`}}>
                        <h3 className="font-bold mb-3 hover-scale text-sm break-words">{index + 1}. {question.question}</h3>
                        <RadioGroup
                        ...
                        >
                          {question.options.map((option, optionIndex) => (
                            <div key={optionIndex} className="flex items-center space-x-2 hover-scale p-2 rounded">
                              ...
                              <Label htmlFor={`q${index}o${optionIndex}`} className="cursor-pointer text-sm break-words">{option}</Label>
                            </div>
                          ))}
                        </RadioGroup>
                      </div>
                  ...
                  <div className="text-center space-y-6">
                    <div className="p-6 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg animate-scale-in overflow-hidden">
                      <CheckCircle className="h-16 w-16 text-green-500 mx-auto mb-4 animate-bounce-gentle" />
                      <h3 className="text-2xl font-bold mb-2 animate-fade-in break-words">퀴즈 완료!</h3>
                      <p className="text-xl animate-fade-in break-words" style={{animationDelay: '0.2s'}}>
                    ...
                    <div className="space-y-4">
                      ...
                      {quizQuestions.map((question, index) => (
                        <div key={index} className="p-4 border rounded-lg text-left hover-scale animate-fade-in overflow-hidden" style={{animationDelay: `${index * 0.1}s`}}>
                          <p className="font-bold mb-2 text-sm break-words">{index + 1}. {question.question}</p>
                          <p className="text-sm">
                            <span className="text-muted-foreground">내 답안: </span>
                            <span className={`break-words ${quizAnswers[index] === question.correct ? "text-green-600 font-bold" : "text-red-600"}`}>
                              {quizAnswers[index] || "미답"}
                            </span>
                          </p>
                          <p className="text-sm">
                            <span className="text-muted-foreground">정답: </span>
                            <span className="text-green-600 font-bold break-words">{question.correct}</span>
                          </p>
                        </div>
                      ))}
                    </div>
